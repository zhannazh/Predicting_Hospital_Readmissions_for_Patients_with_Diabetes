In this project, I build a decision tree model to predict which inpatient visits will result in a 30-day readmission to the hospital in a sample of patients with diabetes.
